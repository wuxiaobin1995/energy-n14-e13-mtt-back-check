 ...
 * @LastEditTime: 2023-06-20 21:38:15
 * @Description : 肌肥大训练-具体测量
-->
<template>
  <div class="muscular-hypertrophy-measure">
    <div class="wrapper">
      <div class="left">
        <!-- 标题 -->
        <div class="title">
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/muscular-hypertrophy-measure'),
