<!--
 * @Author      : Mr.bin
 * @Date        : 2023-06-19 15:36:10
 * @LastEditTime: 2023-06-19 15:37:37
 * @Description : 评估数据统一发送页面
-->
<template>
  <div class="test-send" v-loading.fullscreen.lock="fullscreenLoading">
    <div class="wrapper">
      <div class="title">评估数据统一发送页面</div>
      <div class="text">
        {{ text }}
      </div>
...
export default {
  ...
  methods: {
    ...
    sendData() {
      ...
      // const api = `http://${mttIP}/energy_t6_m5_mtt/public/index.php/imsItemList/sendImsItemListAssessData`
      console.log(api)
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-send'),
